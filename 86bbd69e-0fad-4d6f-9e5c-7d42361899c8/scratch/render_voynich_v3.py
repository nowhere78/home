...
RATE = "+25%" 
OUTPUT_AUDIO = "voynich_audio_v3.mp3"
...
OUTPUT_VIDEO = "voynich_shorts_v3_pro.mp4"

# Windows default font path (Arial is safe)
...
def render_video_with_subtitles():
    ...
    for text, duration in TEXT_BLOCKS:
        ...
        # Style: Large Yellow text, Center, Arial font
        f = (f"drawtext=fontfile='{FONT_PATH}':text='{clean_text}':fontcolor=yellow:fontsize=80:x=(w-text_w)/2:y=(h-text_h)/2"
...
async def main():
    ...
    print("Rendering Professional Video V3...")
    render_video_with_subtitles()
    if os.path.exists(OUTPUT_VIDEO):
        print(f"Success! REAL Pro Video saved as {OUTPUT_VIDEO}")
    else:
