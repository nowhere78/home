...
# --- STRATEGIC CONFIGURATION (IRONCLAD MASTER) ---
...
RATE = "+15%"
OUTPUT_AUDIO = "voynich_audio_ironclad.mp3"
OUTPUT_VIDEO = "!!!_DASHBOARD_VOYNICH_12_IMAGES.mp4"
...
def render_ironclad():
    ...
    with open("images.txt", "w") as f:
        ...
        f.write(f"file '{IMAGES[-1].replace('\\', '/')}'\n") # Last file workaround for FFmpeg

    # 2. Subtitle Filter Chain
    drawtext_filters = []
    ...
    # 3. Final FFmpeg Command (Demuxer + Audio + Subtitles)
    cmd = [
        'ffmpeg', '-y',
...
async def main():
    print("Generating Ironclad Audio...")
    await generate_audio()
    print("Rendering Ironclad Master Video (12 images, 100% Guaranteed Change)...")
    render_ironclad()
    print(f"Success! Ironclad Master Video saved as {OUTPUT_VIDEO}")
