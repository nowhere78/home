# Step 15 Blueprint - Vocational scheduler

## Objective
Implement roadmap step 15 as a production-capable module with deterministic behavior and clear observability.

## Primary Target
- Planned file: `scripts/scheduler.py`
...
## Build Plan
- Homestead/Expedition mode planner, task calendars, location binding
...
- Functional behavior matches roadmap deliverable: Daily activities are scheduled and trackable
