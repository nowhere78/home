# Step 14 Blueprint - Odinsblund nocturnal maintenance

## Objective
Implement roadmap step 14 as a production-capable module with deterministic behavior and clear observability.

## Primary Target
- Planned file: `scripts/nocturnal.py`
...
## Build Plan
- Sleep window manager, summarization jobs, cache pruning jobs
...
- Functional behavior matches roadmap deliverable: Nightly maintenance runs autonomously
