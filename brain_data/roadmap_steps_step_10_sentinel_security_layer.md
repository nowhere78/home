# Step 10 Blueprint - Sentinel security layer

## Objective
Implement roadmap step 10 as a production-capable module with deterministic behavior and clear observability.

## Primary Target
- Planned file: `scripts/security.py`
...
## Build Plan
- Blocklist enforcement, intrusion scoring, async alerts
...
- Functional behavior matches roadmap deliverable: Blocked entities dropped and logged
