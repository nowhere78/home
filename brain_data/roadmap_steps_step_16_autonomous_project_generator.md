# Step 16 Blueprint - Autonomous project generator

## Objective
Implement roadmap step 16 as a production-capable module with deterministic behavior and clear observability.

## Primary Target
- Planned file: `scripts/project_generator.py`
...
## Build Plan
- Multi-day project ideation, progress states, completion evaluator
...
- Functional behavior matches roadmap deliverable: Agent starts and advances self-assigned projects
