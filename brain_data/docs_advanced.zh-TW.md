...
AI Night Shift 基於已建立的自主循環模式。了解這些幫助你選擇正確的配置：
...
1. **無退出條件的無限循環** — 始終設定 `MAX_ROUNDS`、`WINDOW_HOURS`，或使用完成訊號
...
1. 透過 [@BotFather](https://t.me/BotFather) 建立 Telegram Bot
2. 取得你的 chat ID
3. 新增到 `config.env`：
```bash
