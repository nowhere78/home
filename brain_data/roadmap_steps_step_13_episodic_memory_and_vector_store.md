# Step 13 Blueprint - Episodic memory and vector store

## Objective
Implement roadmap step 13 as a production-capable module with deterministic behavior and clear observability.

## Primary Target
- Planned file: `scripts/memory_manager.py`
...
## Build Plan
- Daily summary writer, embedding index, semantic retrieval API
...
- Functional behavior matches roadmap deliverable: Persistent recall with relevance ranking
