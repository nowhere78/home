# Step 18 Blueprint - Prompt synthesizer

## Objective
Implement roadmap step 18 as a production-capable module with deterministic behavior and clear observability.

## Primary Target
- Planned file: `scripts/prompt_synthesizer.py`
...
## Build Plan
- State aggregation, token budget manager, system prompt renderer
...
- Functional behavior matches roadmap deliverable: Single dynamic prompt emitted to router
